...
public class Ball {
    ...
    public boolean checkMouseClicked()
    {
        ...
        PVector vec = new PVector(parent.mouseX - position.x, parent.mouseY - position.y);
        //TODO use Ani to animate random color and radius if clicked
        Random rand = new Random();
        if(vec.mag() <= radius){
            Ani.to(this, 1f, "radius", rand.nextInt(70));
            Ani.to(this, 1f, "r", rand.nextInt(255));
            Ani.to(this, 1f, "g", rand.nextInt(255));
            Ani.to(this, 1f, "b", rand.nextInt(255));
        }
